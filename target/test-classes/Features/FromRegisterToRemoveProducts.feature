#Feature: Manage work flow for user from register to order product and remove
#  @regression
#  Scenario: As a user, i should see products will be show correct after select order and remove
...
#    And   I should see "SP01" displayed on "codeProduct" list screen
